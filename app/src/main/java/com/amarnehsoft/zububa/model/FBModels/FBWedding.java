...
public class FBWedding extends FBUploadable{
    ...
    public FBWedding(long creationDate, String macAddress, String username, String adminCode, long approveDate, String personName, String title, String content, String imgUrl, long weddingDate) {
